...
public class TradeService {
	...
	public String generateDeal(String dealId,String buyer, String goodsId, Timestamp dealTime, String dealPlace) throws Exception {
			Integer state = 0;
			tradeInterface.generateDeal(dealId,buyer, goodsId,dealTime,dealPlace,state);
